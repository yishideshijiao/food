        ...
        <form class="form-horizontal" method="post" enctype="multipart/form-data">
            ...
            <tr>
                <div class="form-group">
                    <div class="col-sm-10">
                        店铺分类ID<input type="text" class="form-control"  name="shop_category_id" value="{{old("shop_category_id",$shop->shop_category_id)}}">
                    </div>
                </div>
            </tr>
            ...
            <tr>
                <div class="form-group">
                    <div class="col-sm-10">
                        名称<input type="text" class="form-control"  name="shop_name" value="{{old("shop_name",$shop->shop_name)}}">
                    </div>
                </div>
            </tr>
            ...
            <tr>
                <div class="form-group">
                    <div class="col-sm-10">
                        店公告<input type="text" class="form-control"  name="notice" value="{{old("notice",$shop->notice)}}">
                    </div>
                </div>
            </tr>
            ...
            <tr>
                <div class="form-group">
                    <div class="col-sm-10">
                        优惠信息<input type="text" class="form-control"  name="discount" value="{{old("discount",$shop->discount)}}">
                    </div>
                </div>
            </tr>
            ...
            <tr>
                <div class="form-group">
                    <div class="col-sm-3">
                        评分：<input type="number" class="form-control"  name="shop_rating" value="{{old("name",$shop->shop_rating)}}">
                    </div>
                </div>
            </tr>
            ...
            <tr>
                <div class="form-group">
                    <div class="col-sm-3">
                        起送金额：<input type="number" class="form-control"  name="start_send" value="{{old("start_send",$shop->start_send)}}">
                    </div>
                </div>
            </tr>
            ...
            <tr>
                <div class="form-group">
                    <div class="col-sm-3">
                        配送费：<input type="number" class="form-control"  name="send_cost" value="{{old("send_cost",$shop->send_cost)}}">
                    </div>
                </div>
            </tr>
            ...
            <tr>
                <div class="form-group">
                    <div class="col-sm-3">
                        用户Id<input type="number" class="form-control"  name="user_id" value="{{old("user_id",$shop->user_id)}}">
                    </div>
                </div>
            </tr>
